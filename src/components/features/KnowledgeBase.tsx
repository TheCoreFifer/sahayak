...
const KnowledgeBase: React.FC = () => {
  ...
  const handleSearch = async (query: string) => {
    ...
    try {
      ...
      if (result.success) {
        setKnowledgeResponse(result.data);
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                className="w-full pl-12 pr-32 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 placeholder-gray-500"
              />
              <button
